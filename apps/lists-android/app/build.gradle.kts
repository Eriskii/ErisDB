// erisdb-lists-android — MIT licensed, © 2026 Isolyth. See LICENSE.
plugins {
...
dependencies {
  ...
  // The real org.json, so the sync engine and the outbox run on the JVM
  // instead of hitting android.jar's throwing stubs.
